...
function parseCommerceSeed(value: unknown) {
  ...
  if (
    ...
    seed.template_id !== "commerce-order-cancellation-v2" ||
    seed.oracle_version !== "commerce-order-oracle-v2" ||
...
function parseCommerceBehavior(value: unknown) {
  ...
  if (
    ...
    artifact.template_id !== "commerce-order-cancellation-v2" ||
...
export async function replayCommerceCampaign(
  ...
  if (
    ...
    taskPack.template_id !== "commerce-order-cancellation-v2" ||
