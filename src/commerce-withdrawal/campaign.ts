...
import type { CommerceBehaviorVector } from "../oracle/commerce-order-v2.js";
...
export interface CommerceArmEvaluationOutput {
  ...
  readonly oracleSeed: {
    ...
    readonly oracle_version: "commerce-order-oracle-v2";
  };
}
...
export async function runCommercePairedCampaign(input: {
  ...
  if (
    ...
    input.taskPackIdentity.template_id !== "commerce-order-cancellation-v2"
  ) {
