...
import { calibrateCommercePackDetailed } from "../oracle/commerce-calibration-v2.js";
import { CommerceOrderOracle } from "../oracle/commerce-order-v2.js";
...
const PACK_ROOT = `${PACKAGE_ROOT}/task-packs/open-coding-ts-commerce-order-v2`;
...
export async function runRealCommerceDelivery(input: {
  ...
  if (
    ...
    taskPackIdentity.template_id !== "commerce-order-cancellation-v2"
  ) {
    throw new CommerceProductionError(
